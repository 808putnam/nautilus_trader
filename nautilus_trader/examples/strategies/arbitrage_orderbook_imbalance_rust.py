...
from nautilus_trader.core.nautilus_pyo3 import ArbitrageBookImbalanceRatio
from nautilus_trader.core.nautilus_pyo3 import ArbitrageOrderBookMbp
...
class ArbitrageOrderBookImbalanceConfig(StrategyConfig, frozen=True):
    """
    Configuration for ``ArbitrageOrderBookImbalance`` instances.
...
class ArbitrageOrderBookImbalance(Strategy):
    """
    ...
    def __init__(self, config: ArbitrageOrderBookImbalanceConfig) -> None:
        ...
        self.book = ArbitrageOrderBookMbp(pyo3_instrument_id, config.use_quote_ticks)
        self.imbalance = ArbitrageBookImbalanceRatio()
