...
from nautilus_trader.adapters.phoenix.http.error import PhoenixClientError
from nautilus_trader.adapters.phoenix.spot.http.market import PhoenixSpotMarketHttpAPI
from nautilus_trader.adapters.phoenix.spot.http.wallet import PhoenixSpotWalletHttpAPI
from nautilus_trader.adapters.phoenix.spot.schemas.market import PhoenixSpotSymbolInfo
...
class PhoenixSpotInstrumentProvider(InstrumentProvider):
    """
    Provides a means of loading instruments from the `Phoenix Spot/Margin` exchange.
    ...
    account_type : PhoenixAccountType, default SPOT
        The Phoenix account type for the provider.
    ...
    def __init__(
        ...
        self._http_wallet = PhoenixSpotWalletHttpAPI(
            self._client,
            clock=self._clock,
            account_type=account_type,
        )
        self._http_market = PhoenixSpotMarketHttpAPI(self._client, account_type=account_type)
    ...
    async def load_all_async(self, filters: dict | None = None) -> None:
        ...
        try:
            ...
            if not self._is_testnet:
                ...
                fees_dict: dict[str, PhoenixSpotTradeFee] = {fee.symbol: fee for fee in response}
            else:
                self._log.warning(
    ...
    async def load_ids_async(
        ...
        symbol_info_dict: dict[str, PhoenixSpotSymbolInfo] = {
    ...
    def _parse_instrument(
        self,
        symbol_info: PhoenixSpotSymbolInfo,
        fee: PhoenixSpotTradeFee | None,
        ts_event: int,
    ) -> None:
        ...
        try:
            ...
            instrument_id = InstrumentId(symbol=raw_symbol, venue=PHOENIX_VENUE)
