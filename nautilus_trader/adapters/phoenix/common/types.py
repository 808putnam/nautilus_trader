...
class PhoenixBar(Bar):
    """
    Represents an aggregated `Phoenix` bar.

    This data type includes the raw data provided by `Phoenix`.
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> PhoenixBar:
        """
        Return a `Phoenix` bar parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: PhoenixBar) -> dict[str, Any]:
        """
...
class PhoenixTicker(Data):
    """
    Represents a `Phoenix` 24hr statistics ticker.
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, PhoenixTicker):
            return False
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> PhoenixTicker:
        """
        Return a `Phoenix Spot/Margin` ticker parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: PhoenixTicker) -> dict[str, Any]:
        """
        Return a dictionary representation of this object.
