...
class PhoenixWebSocketClient:
    """
    Provides a `Phoenix` streaming WebSocket client.
    ...
    async def connect(self) -> None:
        ...
        # Phoenix expects at least one stream for the initial connection
    ...
    async def subscribe_agg_trades(self, symbol: str) -> None:
        ...
        """
        stream = f"{PhoenixSymbol(symbol).lower()}@aggTrade"
    ...
    async def subscribe_trades(self, symbol: str) -> None:
        ...
        """
        stream = f"{PhoenixSymbol(symbol).lower()}@trade"
        await self._subscribe(stream)
    ...
    async def subscribe_bars(
        ...
        """
        stream = f"{PhoenixSymbol(symbol).lower()}@kline_{interval}"
        await self._subscribe(stream)
    ...
    async def subscribe_mini_ticker(
        ...
        if symbol is None:
            ...
            stream = f"{PhoenixSymbol(symbol).lower()}@miniTicker"
        await self._subscribe(stream)
    ...
    async def subscribe_ticker(
        ...
        if symbol is None:
            ...
            stream = f"{PhoenixSymbol(symbol).lower()}@ticker"
        await self._subscribe(stream)
    ...
    async def subscribe_book_ticker(
        ...
        if symbol is None:
            ...
            stream = f"{PhoenixSymbol(symbol).lower()}@bookTicker"
        await self._subscribe(stream)
    ...
    async def subscribe_partial_book_depth(
        ...
        """
        stream = f"{PhoenixSymbol(symbol).lower()}@depth{depth}@{speed}ms"
        await self._subscribe(stream)
    ...
    async def subscribe_diff_book_depth(
        ...
        """
        stream = f"{PhoenixSymbol(symbol).lower()}@depth@{speed}ms"
        await self._subscribe(stream)
    ...
    async def subscribe_mark_price(
        ...
        if symbol is None:
            ...
            stream = f"{PhoenixSymbol(symbol).lower()}@markPrice@{int(speed / 1000)}s"
        await self._subscribe(stream)
