...
class PhoenixOrderHttp(PhoenixHttpEndpoint):
    """
    ...
    def __init__(
        ...
        methods = {
            ...
            HttpMethod.PUT: PhoenixSecurityType.TRADE,
        }
        ...
        self._resp_decoder = msgspec.json.Decoder(PhoenixOrder)
    ...
    class PostParameters(msgspec.Struct, omit_defaults=True, frozen=True):
        ...
        timeInForce : PhoenixTimeInForce, optional
        ...
        side: PhoenixOrderSide
        type: PhoenixOrderType
        timeInForce: PhoenixTimeInForce | None = None
    ...
    async def get(self, parameters: GetDeleteParameters) -> PhoenixOrder:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, parameters)
        return self._resp_decoder.decode(raw)

    async def delete(self, parameters: GetDeleteParameters) -> PhoenixOrder:
        method_type = HttpMethod.DELETE
        raw = await self._method(method_type, parameters)
        return self._resp_decoder.decode(raw)

    async def post(self, parameters: PostParameters) -> PhoenixOrder:
        method_type = HttpMethod.POST
        raw = await self._method(method_type, parameters)
        return self._resp_decoder.decode(raw)

    async def put(self, parameters: PutParameters) -> PhoenixOrder:
        method_type = HttpMethod.PUT
        raw = await self._method(method_type, parameters)
        return self._resp_decoder.decode(raw)


class PhoenixAllOrdersHttp(PhoenixHttpEndpoint):
    """
    ...
    def __init__(
        ...
        self._get_resp_decoder = msgspec.json.Decoder(list[PhoenixOrder])
    ...
    async def get(self, parameters: GetParameters) -> list[PhoenixOrder]:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, parameters)
        return self._get_resp_decoder.decode(raw)


class PhoenixOpenOrdersHttp(PhoenixHttpEndpoint):
    """
    ...
    def __init__(
        ...
        client: PhoenixHttpClient,
        base_endpoint: str,
        methods: dict[HttpMethod, PhoenixSecurityType] | None = None,
    ):
        if methods is None:
            methods = {
                HttpMethod.GET: PhoenixSecurityType.USER_DATA,
...
class PhoenixUserTradesHttp(PhoenixHttpEndpoint):
    """
    ...
    def __init__(
        ...
        self._get_resp_decoder = msgspec.json.Decoder(list[PhoenixUserTrade])
    ...
    async def _get(self, parameters: GetParameters) -> list[PhoenixUserTrade]:
        method_type = HttpMethod.GET
        raw = await self._method(method_type, parameters)
        return self._get_resp_decoder.decode(raw)


class PhoenixAccountHttpAPI:
    """
    Provides access to the Phoenix Account/Trade HTTP REST API.
    ...
    def __init__(
        ...
        # Create endpoints
        self._endpoint_order = PhoenixOrderHttp(client, self.base_endpoint)
        self._endpoint_all_orders = PhoenixAllOrdersHttp(client, self.base_endpoint)
        self._endpoint_open_orders = PhoenixOpenOrdersHttp(client, self.base_endpoint)
        self._endpoint_user_trades = PhoenixUserTradesHttp(client, user_trades_url)
    ...
    async def query_order(
        ...
        phoenix_order = await self._endpoint_order.get(
    ...
    async def cancel_order(
        ...
        phoenix_order = await self._endpoint_order.delete(
            parameters=self._endpoint_order.GetDeleteParameters(
                symbol=PhoenixSymbol(symbol),
                timestamp=self._timestamp(),
                orderId=order_id,
    ...
    async def new_order(
        ...
        symbol: str,
        side: PhoenixOrderSide,
        order_type: PhoenixOrderType,
        time_in_force: PhoenixTimeInForce | None = None,
        quantity: str | None = None,
        ...
        """
        Send in a new order to Phoenix.
        """
        phoenix_order = await self._endpoint_order.post(
    ...
    async def modify_order(
        ...
        """
        Modify a LIMIT order with Phoenix.
        """
        phoenix_order = await self._endpoint_order.put(
