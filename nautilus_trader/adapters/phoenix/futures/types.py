...
class PhoenixFuturesMarkPriceUpdate(Data):
    """
    Represents a `Phoenix Futures` mark price and funding rate update.
    ...
    @staticmethod
    def from_dict(values: dict[str, Any]) -> "PhoenixFuturesMarkPriceUpdate":
        """
        Return a `Phoenix Futures` mark price update parsed from the given values.
    ...
    @staticmethod
    def to_dict(obj: "PhoenixFuturesMarkPriceUpdate") -> dict[str, Any]:
        """
